  ...
  return (
    <div className={styles.container}>
      <form className={styles.formLogin} onSubmit={submitHandler} autoComplete="off">
        ...
        <div>
          <div>
            <input type="text" name="otp" value={data.email} placeholder="Otp" onChange={changeHandler} onFocus={focusHandler} autoComplete="off" />
       ...
       <div>
          <div>
            <input type="password" name="confirm_pwd" value={data.confirm_pwd} placeholder="Confirm Password" onChange={changeHandler} onFocus={focusHandler} autoComplete="off" />
            <img src={passwordIcon} alt="" />
          </div>
        </div>
        <div>
